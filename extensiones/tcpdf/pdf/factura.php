		...
		<tr>
			...
			<td style="background-color:white; width:180px">
				...
				<div style="font-size:8.5px; text-align:right; line-height:15px;">
					...
					<br>
					Teléfono: 758-103-60-78

					<br>
					cadenagarc@hotmail.com

				</div>

			</td>

			<td style="background-color:white; width:180px; text-align:center; color:red"><br><br>NOTA DE VENTA.<br>$valorVenta</td>
...
$bloque3 = <<<EOF
	...
	<table style="font-size:10px; padding:5px 10px;">
		...
		<th style="border: 1px solid #666; background-color:white; width:100px; text-align:center">Valor Unit.</th>
...
$valorUnitario = number_format($item["carrito_costo"], 2);

 $precioTotal = number_format($item["carrito_total"], 2);
